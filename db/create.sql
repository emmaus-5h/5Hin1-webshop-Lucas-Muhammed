...
insert into products (name, description, price, ratings_id, levertijd_id, opslag_id, allergie_id) values              ('Baklava Choco', 'Baklava maar dan met chocolade voor de mensen die en chocolade en baklava lekker vinden.',         20, 1, 5, 4, 1);
...
insert into products (name, description, price, ratings_id, levertijd_id, opslag_id, allergie_id) values              ('Dürüm Baklava', 'Dürüm baklava met pistache', 20.50, 3, 2, 2, 3);
...
insert into products (name, description, price, ratings_id, levertijd_id, opslag_id, allergie_id) values              ('Kokos Bülbül','Baklava met kokos in een bijzonder vorm', 21.99, 2, 4, 2, 1);  
  
insert into products (name, description, price, ratings_id, levertijd_id, opslag_id, allergie_id) values              ('Driehoek Baklava', 'Driehoek Baklava met Pistache heeft, zoals de naam al doet vermoeden, de vorm van een           driehoek. Het wordt meestal geserveerd met ijs ertussen.', 25.99, 2, 5, 2, 3);   
