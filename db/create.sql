...
insert into products (name, description, code, price) values ('Baklava Pistache', 'Het is lekker', '816905633-0', 10.5);
...
insert into products (name, description, code, price) values ('Baklava Chocolade', 'Pellentesque at nulla. Suspendisse potenti.', '445924201-X', 13.5);
insert into products (name, description, code, price) values ('Baklava Roze', 'Duis bibendum, felis sed interdum venenatis, turpis enim blandit mi, in porttitor pede justo eu massa.', '693155505-7', 13.5);
